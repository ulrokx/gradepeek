...
export const SCHOOL_URL = new URL("https://sit.instructure.com/")
export const TODOS_URL = new URL("https://sit.instructure.com/api/v1/users/self/todo")
export const GRADES_URL = new URL("https://sit.instructure.com/api/v1/users/")