...
export const PopupReducer = (
  ...
  switch (action.type) {
    ...
    case "setOptions":
      const { courseName, gradeName, hiddenCourses } = action.payload.options;
      if (courseName) {
      ...
      return {
        ...state,
        options: {
          courseName: courseName ? courseName : state.options.courseName,
    ...
    case "removeHidden":
      ...
      const newerArr = state.options.hiddenCourses.filter((c) => c != toRemove);
    ...
    case "setVersion":
      return {
        ...
        options: {
          ...state.options,
          version: action.payload.options.version,
        },
      };
  }
};
